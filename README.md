...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a73e8,100:0d1117&height=200&section=header&text=Theekshana%20Chathuranga&fontSize=42&fontColor=ffffff&fontAlignY=38&desc=Full-Stack%20Developer%20%7C%20DevOps%20Enthusiast%20%7C%20Cloud%20Explorer&descAlignY=58&descSize=16&descColor=93c5fd" />
...
const theekshana = {
  ...
  university: "University of Ruhuna — BICTHons (2022–Present)",
  training:   "Linux Systems Administration & DevOps @ WSO2 (2025–2026)",
  location:   "Kurunegala, Sri Lanka 🇱🇰",
  focus:      ["Scalable Web Apps", "REST APIs", "Cloud Infrastructure", "CI/CD"],
  motto:      "Build fast, secure, and ship with confidence."
};
```

I'm a final-year undergraduate specializing in **full-stack development and scalable system design**. I enjoy bridging the gap between clean frontend experiences and robust backend architecture, while incorporating DevOps practices to ship reliable software.

Currently deepening my expertise through **WSO2's DevOps Engineering program**, working hands-on with Kubernetes, Terraform, Ansible, and GitOps workflows.
...
| 🐙 GitHub Foundations Professional Certificate | GitHub |
| 🤖 AI & Machine Learning Engineer – Stage 1 | SLIIT |
...
- 🟣 **Terraform Cloud** — Remote state, workspaces, policy as code
- 🔴 **GitOps** — ArgoCD & Flux for declarative deployments
- 🟠 **Prometheus & Grafana** — Observability & monitoring pipelines
- 🔵 **OpenSearch** — Log management & analytics

---

## 🤝 Volunteering & Leadership

**🎓 Academic Mentor** · ICT Students' Circle, University of Ruhuna *(May 2024 – Present)*
> Mentoring students with academic guidance, technical knowledge-sharing, and university experience.

**🎨 Media Team Member** · ICT Students' Circle, University of Ruhuna *(Feb 2024 – Feb 2025)*
> Led graphic design and web content creation for departmental media channels.
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:0d1117,50:1a73e8,100:0d1117&height=120&section=footer" />

*"Build it right, secure it well, and automate the rest."*
